...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/application_internal_draw_dto.DrawListResp"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateDrawReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/apis/draw/v1/admin/draws/{id}/run": {
            "post": {
                "description": "Admin: run a pending draw — selects a winning ticket and records the winner. Rejects an already-run draw.",
                "produces": [
                    "application/json"
                ],
                "tags": [
    ...
    "definitions": {
        ...
        "application_internal_draw_dto.DrawListResp": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
